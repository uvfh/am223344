...
elseif placeId == 7449423635 then
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "xonom Hub", 
        Text = "สคริปตัวนี้กังจัดดดด",
        Icon = "",
        Duration = 5
    })
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/naypramx/Ui__Project/Script/XeNonUi", true))()
    local CenterHubNo1 = library:CreateWindow("xonom Hub",Enum.KeyCode.RightControl)
...
function click()
 ...
 function TP(P)
   ...
   local Speed = 310 -- ความเร็วของมึง
   ...
   tween:Play()
    ...
    AutoFarm:AddToggle("Auto Farm",_G.AutoFarm,function(value)
        AutoFarm Level",false,function(vu)
    _G.AutoFarm = vu
   ...
   AutoFarm:AddToggle("Fast Attack",true,function(Fast)
    _G.FastAttack = Fast
end)
...
task.wait()
    ...
    local Sector1 = Tab:CreateSector("Fighting Style","Left")
    ...
    Sector1:AddToggle("Auto DeathStep",_G.AutoDeathStep,function(value)
    ...
    Sector1:AddToggle("Auto Sharkman Karate",_G.AutoSharkman,function(value)
    ...
    Sector1:AddToggle("Auto Electric Claw",_G.AutoElectricClaw,function(value)
    ...
    Sector1:AddToggle("Auto Dragon Talon",_G.AutoDragonTalon,function(value)
...
spawn(function()
   game:GetService("RunService").RenderStepped:Connect(function()
    ...
    Tab:CreateSector("Dought","Left")
    Sector1:AddLabel("Boss Dough v1")
    Sector1:AddToggle("Auto Dought Boss",_G.AutoDoughtBoss,function(value)
    ...
    Sector1:AddSeperator("Advance Dungeon")
    
    Sector1:AddToggle("Auto Advance Dungeon",_G.AutoAdvanceDungeon,function(value)
